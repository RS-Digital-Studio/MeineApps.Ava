...
namespace ArcaneKingdom.UI.Foundation
{
    ...
    /// (damit Domain-Services per Constructor injiziert werden können).
    /// </summary>
    public interface IScreenFactory
    {
        /// <summary>Erzeugt einen Screen anhand seiner ID (siehe <see cref="ScreenId"/>).</summary>
        /// <exception cref="System.InvalidOperationException">Wenn kein Screen für die ID registriert ist.</exception>
