...
|-------------|------|
| Version | v1.3.0 |
| Status | Entwicklung — **Buch-Only Strip Phase 2 (21.04.2026) abgeschlossen** + **Auto-Resume + UI-Watchdog (24.04.2026)** + **Remote-Deep-Audit + Hardening (24.04.2026)** + **Strict-Mode Phase 1+2 (25.04.2026)** |
