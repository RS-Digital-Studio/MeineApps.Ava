...
| Eigenschaft | Wert |
|-------------|------|
| Version | v1.7.0 (Phasen 10-17 + Cross-TF-Pyramiding-Lifecycle, Code-vollständig) |
| Status | Entwicklung — **OPTIMIZATION_PLAN_2026-05 vollständig umgesetzt (06.05.2026)**: Phasen 0-17 inkl. UI-Toggles (Pyramiding/Slippage/Adaptive-TF), DecisionTrailView (10A), Stats-Breakdown-Card im Dashboard (10B), Walk-Forward-UI im Backtest (10C), SettingsHistoryView (Phase 14), Phase 16 Cross-TF-Pyramiding-Lifecycle in TradingServiceBase. Pi-Deploy + Live-Verifikation = nächste Schritte. |
