...
///
/// 1:1-Port aus dem produktiven Avalonia-HandwerkerImperium
/// (Models/GameBalanceConstants.cs). Werte sind die verbindliche Wahrheit (ORIGINAL_WERTE.md).
/// </summary>
public static class GameBalanceConstants
{
    ...
    /// <summary>
    /// Maximales Workshop-Level. 1000 ist der aktuelle Hard-Cap und das Rebirth-Trigger-Niveau.
    /// </summary>
