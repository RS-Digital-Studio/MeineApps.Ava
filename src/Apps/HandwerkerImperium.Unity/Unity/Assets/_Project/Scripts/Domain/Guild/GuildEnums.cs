namespace HandwerkerImperium.Domain.Guild
{
    ...
    // 1:1-Port aus dem Avalonia-Original (Models/GuildEnums.cs).

    /// <summary>Rolle eines Spielers innerhalb einer Gilde.</summary>
    ...
    /// <summary>Liga-Stufe einer Gilde im Saison-System. Bestimmt Matchmaking und Belohnungen.</summary>
    ...
    /// <summary>Phase eines Gilden-Kriegs innerhalb einer Saison-Woche.</summary>
    ...
    /// <summary>Status eines kooperativen Gilden-Bosses.</summary>
    ...
    /// <summary>
    /// Gebäude-IDs für das Gilden-Hauptquartier. Jedes Gebäude hat eigene Boni und Upgrade-Stufen.
    /// </summary>
    ...
    /// <summary>Typen kooperativer Gilden-Bosse. Jeder Boss hat eigene HP-Skalierung und Schadensregeln.</summary>
    ...
    /// <summary>Kategorien für Gilden-Achievements.</summary>
    ...
    /// <summary>Stufe eines Gilden-Achievements (Bronze/Silver/Gold). Höhere Stufen geben bessere Belohnungen.</summary>
