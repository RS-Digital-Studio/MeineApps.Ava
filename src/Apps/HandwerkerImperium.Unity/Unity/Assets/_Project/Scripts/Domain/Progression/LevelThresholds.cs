namespace HandwerkerImperium.Domain.Progression
{
    ...
    ///
    /// 1:1-Port aus dem Avalonia-Original (Models/LevelThresholds.cs). Reine int-Konstanten
    /// (Feature-/Tab-/Automation-Gates) — plattformunabhängiges Domain-Wissen.
    /// </summary>
    public static class LevelThresholds
    {
        ...
        public static readonly int[] TabUnlockLevels = new int[] { 1, 5, 8, 15, 3 };
        ...
        public const int HintQuickJobs = 2;
        ...
        public const int TournamentSection = 35;

        /// <summary>Saisonale Events im Missionen-Tab anzeigen.</summary>
        public const int SeasonalEventSection = 45;

        /// <summary>Battle Pass im Missionen-Tab anzeigen.</summary>
        public const int BattlePassSection = 55;
