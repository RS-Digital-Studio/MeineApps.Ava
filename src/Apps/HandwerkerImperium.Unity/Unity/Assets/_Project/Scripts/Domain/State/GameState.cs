...
// Alias: der Research-Typ kollidiert von außerhalb mit dem gleichnamigen Namespace (CS0118).
using ResearchModel = HandwerkerImperium.Domain.Research.Research;

namespace HandwerkerImperium.Domain.State
{
    public class GameState
    {
        ...
        [JsonProperty("totalGoldenScrewsEarned")]
        public long TotalGoldenScrewsEarned { get; set; }

        [JsonProperty("totalGoldenScrewsSpent")]
        ...
        /// </summary>
        [JsonProperty("lastShopAdRewardTime")]
        ...
        /// </summary>
        [JsonProperty("lastGoldenScrewsAdTime")]
        ...
        /// </summary>
        [JsonProperty("unlockedWorkshopTypes")]
        public List<WorkshopType> UnlockedWorkshopTypes { get; set; } = new() { WorkshopType.Carpenter };

        // ═══════════════════════════════════════════════════════════════════════
        // WORKERS
        // ═══════════════════════════════════════════════════════════════════════

        [JsonProperty("workerMarket")]
        ...
        /// </summary>
        [JsonProperty("parallelOrdersByWorkshop")]
        ...
        [JsonProperty("lastOrderCooldownStart")]
        public DateTime LastOrderCooldownStart { get; set; } = DateTime.MinValue;

        [JsonProperty("weeklyOrderReset")]
        ...
        /// </summary>
        [JsonProperty("lastReputationDecay")]
        ...
        public List<ResearchModel> Researches { get; set; } = new();

        [JsonProperty("activeResearchId")]
        ...
        /// </summary>
        [JsonProperty("consecutiveNegativeEvents")]
        ...
        [JsonProperty("prestigeMultiplier")]
        ...
        [JsonProperty("dailyChallengeState")]
        ...
        /// </summary>
        [JsonProperty("notificationInbox")]
        public List<NotificationItem> NotificationInbox { get; set; } = new();
        ...
        [JsonProperty("repShopRegularCustomerCharges")]
        ...
        [JsonProperty("repShopFasterDeliveryUntil")]
        ...
        [JsonProperty("repShopWoodPremiumSkinUnlocked")]
        ...
        [JsonProperty("repShopInsuranceCharges")]
        ...
        /// </summary>
        [JsonProperty("claimedCoopOrderIds")]
        public List<string> ClaimedCoopOrderIds { get; set; } = new();
        ...
        /// </summary>
        [JsonProperty("claimedAuctionIds")]
        public List<string> ClaimedAuctionIds { get; set; } = new();
        ...
        /// </summary>
        [JsonProperty("claimedGuildProjectIds")]
        public List<string> ClaimedGuildProjectIds { get; set; } = new();
        ...
        /// </summary>
        [JsonProperty("collectedMasterTools")]
        public List<string> CollectedMasterTools { get; set; } = new();
        ...
        /// </summary>
        [JsonProperty("viewedStoryIds")]
        public List<string> ViewedStoryIds { get; set; } = new();

        /// <summary>
        /// ID des nächsten ungesehenen Story-Kapitels (für Badge-Anzeige).
        /// </summary>
        [JsonProperty("pendingStoryId")]
        ...
        public List<Equipment> EquipmentInventory { get; set; } = new();

        // ═══════════════════════════════════════════════════════════════════════
        // TOURNAMENTS ()
        // ═══════════════════════════════════════════════════════════════════════

        [JsonProperty("currentTournament")]
        public Tournament? CurrentTournament { get; set; }

        /// <summary>Datum des letzten Lieferauftrags-Resets.</summary>
        [JsonProperty("lastMaterialOrderReset")]
        public string LastMaterialOrderReset { get; set; } = "";

        /// <summary>Set der abgeschlossenen Crafting-Rezept-IDs.</summary>
        [JsonProperty("completedRecipeIds")]
        public List<string> CompletedRecipeIds { get; set; } = new();

        /// <summary>Set der MiniGame-Typen mit mindestens einem Perfect Rating.</summary>
        [JsonProperty("perfectMiniGameTypes")]
        public List<string> PerfectMiniGameTypes { get; set; } = new();
        ...
        /// </summary>
        [JsonProperty("perfectRatingCounts")]
        ...
        /// </summary>
        [JsonProperty("lifetimePerfectRatingCounts")]
        ...
        /// </summary>
        [JsonProperty("claimedMiniGameMasteryTiers")]
        ...
        [JsonProperty("currentSeasonalEvent")]
        ...
        /// </summary>
        [JsonProperty("isPrestigePassActive")]
        ...
        /// </summary>
        [JsonProperty("claimedLevelOffers")]
        public List<int> ClaimedLevelOffers { get; set; } = new();
        ...
        [JsonProperty("craftingInventory")]
        public Dictionary<string, int> CraftingInventory { get; set; } = new();

        [JsonProperty("activeCraftingJobs")]
        public List<CraftingJob> ActiveCraftingJobs { get; set; } = new();
        ...
        /// </summary>
        [JsonProperty("warehouseSlotCount")]
        ...
        /// </summary>
        [JsonProperty("warehouseStackLimit")]
        ...
        /// </summary>
        [JsonProperty("heirloomItems")]
        public List<string> HeirloomItems { get; set; } = new();
        ...
        [JsonProperty("hasPurchasedStarterPack")]
        ...
        [JsonProperty("lastBossOrderDate")]
        public DateTime LastBossOrderDate { get; set; } = DateTime.MinValue;

        [JsonProperty("bossOrdersCompleted")]
        ...
        /// </summary>
        [JsonProperty("maxOfflineEarnings")]
