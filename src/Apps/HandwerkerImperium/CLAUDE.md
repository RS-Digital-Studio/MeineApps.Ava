...
- **Story-System** (10 Kapitel von NPC "Meister Hans", fortschrittsbasierte Freischaltung, Geld/Schrauben/XP-Belohnungen)
...
| Workshop-Animationen | 8 große erkennbare Szenen-Animationen pro Workshop-Typ (WorkshopView.axaml.cs): Carpenter (Säge schneidet Brett), Plumber (L-Rohrsystem+Wasserfluss+Ventilrad), Electrician (3 Kabel+Strom-Pulse+Verteilerdose), Painter (Wand wird mit Roller gestrichen), Roofer (Dachziegel progressiv gelegt), Contractor (Backsteinmauer wächst von unten), Architect (Bauplan progressiv gezeichnet), GeneralContractor (Goldener Vertrag+Stempel+Shimmer). Worker-Skalierung (0/1/2-3/4+), Extra-Effekte ab 4+ Workern |
...
| Rohr-Puzzle Renderer | PipePuzzleRenderer (SkiaSharp): Metall-Rohre auf Beton-Kacheln, Flansche an Rohrenden, Niet-Detail in Mitte, Wasser-Puls-Animation (Sinus-Glow), Quell(S)/Ziel(Z)-Indikatoren, Touch-HitTest, 20fps Render-Loop |
| Streich-MiniGame Renderer | PaintingGameRenderer (SkiaSharp): Putzwand-Hintergrund mit Fugenlinien, Zellen mit Pinselstrich-Textur/Haekchen/X-Markierung, pulsierende Zielmarkierung + gestrichelter Rand (animiert), Farbspritzer-Partikel (5 pro Treffer, verblassend), Touch-HitTest mit DPI-Skalierung, 20fps Render-Loop |
| Bauplan-MiniGame Renderer | BlueprintGameRenderer (SkiaSharp): Dunkelblauer Blaupausen-Hintergrund (#1A237E) mit feinen/groben Grid-Linien, abgerundete Kacheln mit Icon+Nummer, pulsierender gelber Rand fuer aktiven Schritt, gruenes Haekchen bei erledigten Schritten, Fehler-Overlay rot, Blaupausen-Staub-Partikel (15 max, schwebendes Driften), Touch-HitTest mit DPI-Skalierung, 20fps Render-Loop |
...
| Inspektions-MiniGame Renderer | InspectionGameRenderer (SkiaSharp): Betongrau-Baustellen-Hintergrund (#607D8B) mit Rissen/Fugen, abgerundete Kacheln mit Baustellen-Icons, gruener Rahmen+Haekchen bei gefundenen Maengeln, roter Rahmen+X bei Fehlalarmen, subtiles rotes Schimmern auf unentdeckten Defekten (Sinus-Puls), Lupe-Deko (schwankend), Staub-Partikel (15 max, aufsteigend+Wind-Drift+Fade), Touch-HitTest mit DPI-Skalierung, 20fps Render-Loop |
...
- **v2.0.3 (15.02.2026)**: Story-System: 10 Kapitel von NPC "Meister Hans" (StoryChapter Model, IStoryService/StoryService, DI-Registrierung). Fortschrittsbasierte Freischaltung (Level, Workshops, Aufträge, Prestige). Belohnungen: Geld, Goldschrauben, XP. GameState erweitert um ViewedStoryIds + PendingStoryId.
