...
public sealed class BlueprintGameRenderer : IDisposable
{
        ...
        int completed, int total, float y)
    {
        ...
        // Text "X/Y" (gecacht, nur bei Aenderung neu formatieren)
        ...
        canvas.DrawText(_cachedProgressText, bounds.MidX, y + barHeight + 12, SKTextAlign.Center, s_progressFont, _progressTextPaint);
    }
