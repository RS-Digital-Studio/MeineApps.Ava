...
public static class Achievements
{
    public static List<Achievement> GetAll()
    {
        ...
        [
            ...
            new() { Id = "prestige_total_5", TitleKey = "AchPrestigeTotal5", TitleFallback = "Veteran Prestige", DescriptionKey = "AchPrestigeTotal5Desc", DescriptionFallback = "Complete 5 prestiges total", Category = AchievementCategory.Prestige, Icon = "Creation", TargetValue = 5, MoneyReward = 25_000, XpReward = 500, GoldenScrewReward = 25 },
            new() { Id = "prestige_total_10", TitleKey = "AchPrestigeTotal10", TitleFallback = "Prestige Addict", DescriptionKey = "AchPrestigeTotal10Desc", DescriptionFallback = "Complete 10 prestiges total", Category = AchievementCategory.Prestige, Icon = "Creation", TargetValue = 10, MoneyReward = 100_000, XpReward = 1500, GoldenScrewReward = 50 },
            new() { Id = "prestige_total_25", TitleKey = "AchPrestigeTotal25", TitleFallback = "Prestige Master", DescriptionKey = "AchPrestigeTotal25Desc", DescriptionFallback = "Complete 25 prestiges total", Category = AchievementCategory.Prestige, Icon = "Creation", TargetValue = 25, MoneyReward = 500_000, XpReward = 3000, GoldenScrewReward = 100 },
            new() { Id = "prestige_total_50", TitleKey = "AchPrestigeTotal50", TitleFallback = "Prestige Legend", DescriptionKey = "AchPrestigeTotal50Desc", DescriptionFallback = "Complete 50 prestiges total", Category = AchievementCategory.Prestige, Icon = "Crown", TargetValue = 50, MoneyReward = 2_000_000, XpReward = 7500, GoldenScrewReward = 250 },
