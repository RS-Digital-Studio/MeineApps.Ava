...
public sealed class FtueService : IFtueService
{
    ...
    [
        new() { Id = "ftue_welcome",          Order = 0, TitleKey = "FtueWelcomeTitle",          TextKey = "FtueWelcomeText",          ExpectedAction = FtueExpectedAction.TapContinue,           CanSkip = true }, // v2.1.1 (Audit U-L07): Skip ab Step 1 erlauben
        new() { Id = "ftue_first_upgrade",    Order = 1, TitleKey = "FtueFirstUpgradeTitle",     TextKey = "FtueFirstUpgradeText",     ExpectedAction = FtueExpectedAction.BuyFirstUpgrade,        SpotlightAutomationId = "Dashboard_Btn_WorkshopUpgrade", CanSkip = true }, // v2.1.1 (Audit U-L07): Skip ab Step 1 erlauben
        new() { Id = "ftue_first_order",      Order = 2, TitleKey = "FtueFirstOrderTitle",       TextKey = "FtueFirstOrderText",       ExpectedAction = FtueExpectedAction.AcceptFirstOrder,       SpotlightAutomationId = "Dashboard_Btn_AcceptOrder",     CanSkip = true }, // v2.1.1 (Audit U-L07): Skip ab Step 1 erlauben
        new() { Id = "ftue_first_minigame",   Order = 3, TitleKey = "FtueFirstMiniGameTitle",    TextKey = "FtueFirstMiniGameText",    ExpectedAction = FtueExpectedAction.CompleteFirstMiniGame,                                                          CanSkip = true }, // v2.1.1 (Audit U-L07): Skip ab Step 1 erlauben
