...
// Partielle Klasse: Initialisierung + Cloud-Save.
// Welcome-Flow (Offline-Earnings, Daily-Reward, Starter-Offer, Dialog-Kaskade) liegt in WelcomeFlowViewModel.
public sealed partial class MainViewModel
{
    ...
    public async Task InitializeAsync()
    {
        ...
        WelcomeFlowVM.RunStartupDialogSequence();
