...
public sealed partial class MainViewModel : ViewModelBase, IDisposable, Services.Interfaces.INavigationHost
{
    ...
    // HELPERS (FormatMoney, UpdateNetIncomeHeader, UpdateWorkerWarning, AnimateMoneyTo, GetWorkshopIconKind) → MainViewModel.Helpers.cs
    // PauseGameLoop, ResumeGameLoop, OnLiveOrderSpawned, Dispose → MainViewModel.Lifecycle.cs
}
