...
/// 180 = Süd (Nordhalbkugel). <see cref="TargetTilt"/> ist der ideale Neigungswinkel gegen
/// die Horizontale; <see cref="RecommendedKickstandTilt"/> der nächste am Panel real
/// einstellbare Wert (bei festem Kickstand). Die Erklärung wird vom UI-Layer lokalisiert
