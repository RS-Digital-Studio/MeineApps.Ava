...
/// <summary>
/// Berechnet den Sonnenstand (Azimut/Elevation) und die Sonnenzeiten für einen Ort und
/// Zeitpunkt — vollständig offline. Reine Astronomie-Mathematik, plattformneutral und testbar.
/// </summary>
public interface ISolarPositionService
{
    ...
    /// <summary>Sonnenauf-/-untergang und Sonnen-Höchststand (alles UTC) für einen Tag.</summary>
    ...
    /// (UTC, über 24 Stunden ab Mitternacht UTC des Datums). Für die Sonnenbahn-Visualisierung.</summary>
