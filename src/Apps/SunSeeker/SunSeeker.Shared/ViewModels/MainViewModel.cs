...
/// <summary>
/// Dashboard-ViewModel (Phase 1): zeigt live Standort, Sonnenstand, Sonnenzeiten, die
/// empfohlene Soll-Ausrichtung je Ziel/Panel und die Bifazial-Empfehlung je Untergrund.
/// Die Live-Ausrichtung per Geraete-Sensoren (Kompass/Neigung) und die Tab-Navigation folgen
/// in spaeteren Phasen.
/// </summary>
public partial class MainViewModel : ObservableObject
{
        ...
        IBifacialService bifacial)
    {
        ...
        _selectedPanel = Panels[0];                 // PS400 Bifazial
        _selectedGoal = Goals[0];                   // Jetzt maximal
        _selectedGround = Grounds[0];               // Gras
    }
    ...
    /// <summary>Berechnet Sonnenstand, Empfehlung und Bifazial-Hinweise neu.</summary>
    private void Refresh()
    {
        ...
        KickstandText = panel.HasFixedTilts
            ? $"Standwinkel {rec.RecommendedKickstandTilt:0}° waehlen"
            : "";
        RecommendationExplanation = rec.Explanation;

        // Direkt-Ertrag bei empfohlener Ausrichtung (cosine-loss zur aktuellen Sonne)
        if (sun.IsDaylight)
        {
