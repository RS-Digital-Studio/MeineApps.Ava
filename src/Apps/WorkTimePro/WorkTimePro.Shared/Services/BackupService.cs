...
/// <summary>
/// Implementation of the local JSON backup service (Export/Import).
/// </summary>
public sealed class BackupService : IBackupService
{
    ...
    /// <summary>
    /// Dateiname-Muster für Disk-Safety-Backups (vor Import angelegt, nach Erfolg gelöscht).
    /// Bei Restore-Fehler dient die Datei dem internen Rollback in
    /// <see cref="ImportBackupFromFileAsync"/>.
    /// </summary>
    ...
    // === Disk-Safety-Backup (Rollback bei fehlgeschlagenem Import) ===

    /// <summary>
    /// Schreibt das übergebene Backup als zusätzliche Safety-Datei auf Disk.
    /// Wird VOR dem Clear/Restore in <see cref="ImportBackupFromFileAsync"/> aufgerufen —
    /// schlägt der Import fehl, dient die Datei dem Rollback auf den vorherigen Stand.
    /// </summary>
