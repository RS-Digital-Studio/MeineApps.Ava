...
- **Fullscreen Alarm-Overlay:** Pulsier-Animation, Dismiss + Snooze Buttons, Math-Challenge + Shake-Challenge zum Aufwachen
- **Pomodoro:** PomodoroViewModel mit konfigurierbaren Zeiten (Work/ShortBreak/LongBreak), Zyklus-Tracking (Zyklen bis Langpause), Auto-Start nächste Phase, Focus-Statistiken (Heute + Woche mit Balkendiagramm/DayStatistic), FocusSession DB-Persistierung, Celebration + FloatingText bei Session-Abschluss, Config-Dialog (Preferences-gespeichert)
